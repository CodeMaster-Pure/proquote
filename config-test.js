const config = {
  ...
  from: 'HomeHelp@proquote.online',
  agentsInfo: {
    'guard': {email: 'info@guardha.com', name: 'Guard Agency', phone: '610-699-9000', logo: 'guard_logo.png'},
    'pete': {
...
//      email:'solutionweb79@gmail.com',
    ...
    'zo': {email: 'larenzo@guardha.com', name: 'Larenzo Davenport ', phone: '', logo: 'guard_logo.png'},
    'bill': {
    ...
    'premier': {email: 'quote@premierha.com', name: 'Premier Agency', phone: '856-544-9330', logo: 'premier-logo.png'},
    'ironvalley': {
  ...
  car_types: [
    'Tesla','Acura', 'Alfa Romero', 'Audi', 'Bentley', 'BMW', 'Buick', 'Cadilac', 'Chevrolet', 'Chrysler', 'Dodge', 'Ferrari',
    'Fiat', 'Ford', 'Genesis', 'GMC', 'Honda', 'Hyundai', 'Infiniti', 'Isuzu', 'Jaguar', 'Jeep', 'Kia', 'Lamborghini',
    'Land Rover', 'Lexus', 'Lincoln', 'Maserati', 'Mazda', 'Mercedes', 'Mini', 'Mitsbushi', 'Nissan', 'Porsche', 'RAM',
    'Rolls-Royce', 'Saturn', 'Subaru', 'Tesla', 'Toyota', 'Volkswagen', 'VOLVO'
  ],
  demoData: {
    first_name: 'Peter',
    last_name: 'Hughes',
